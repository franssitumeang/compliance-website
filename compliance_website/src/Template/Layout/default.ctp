                    ...
                    <div class="row section-gap">
                        ...
                        <div class="col-lg-4  col-md-6 col-sm-6">
                            <div class="single-footer-widget">
                                <h4>Hubungi Kami</h4>
                                <p class="address">
                                    Jl. Gn. Sahari Raya No.32, RT.12/RW.4, Gn. Sahari Utara, Sawah Besar, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10720
                                </p>
                                <p class="number">
                                    Telp : (021) 6012070
                                </p>
                        ...
                        <div class="container">
                            <div class="row footer-bottom d-flex justify-content-between align-items-center">
                                <p class="col-lg-8 col-mdcol-sm-6 -6 footer-text m-0">
                                    ...
                                    Copyright &copy;
                                    <script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="compliance.Wahanaartha.com">Compliance Wahana Artha</a> 
                                </p>
