<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">
                    <a href="users" style="color:#669DE0;"><span class="menu-icon fa fa-building-o"></span>&nbsp; Daftar User</a>
                </h5>
                    ...
                    <div class="col-2" style="padding-left: 0px;">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <button id="<?=$s->id?>" class="btn btn-icons btn-inverse-primary" data-toggle="tooltip" title="edit"
                                            style="margin-top:-22px; margin-bottom:-20px;"><i class="fa fa-edit"></i></button>
                                            <span data-target="#myModal" data-toggle="modal"><button id="btn_delete_<?=$s->id?>" class="btn btn-icons btn-inverse-danger delete" data-toggle="tooltip" data-tooltip="" title="delete"
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <select class="form-control selectpicker" name="department_id" id="department_id" required>
