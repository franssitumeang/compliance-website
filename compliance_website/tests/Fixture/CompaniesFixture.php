...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fax_num' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => '119d4db9-7ff5-404a-8b2d-36fa52955a95',
                'company_code' => 'Lor',
                ...
                'created' => '2018-10-04 02:54:43',
                'modified' => '2018-10-04 02:54:43'
            ],
        ];
        parent::init();
    }
